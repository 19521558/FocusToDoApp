...
[assembly: ExportRenderer(typeof(ForcusToDo.Controls.NullableTimePicker), typeof(NullableTimePickerRenderer))]
namespace NullableTimePicker.Droid
{
    public class NullableTimePickerRenderer : ViewRenderer<ForcusToDo.Controls.NullableTimePicker, EditText>
    {
        TimePickerDialog _dialog;
        
        public NullableTimePickerRenderer(Context context) : base(context) { }

        protected override void OnElementChanged(ElementChangedEventArgs<ForcusToDo.Controls.NullableTimePicker> e)
        {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == ForcusToDo.Controls.NullableTimePicker.NullableTimeProperty.PropertyName && Control != null && Element != null)
            {
                Control.Text = !Element.NullableTime.HasValue ? Element.PlaceHolder : DateTime.Today.Add(Element.NullableTime.Value).ToString(Element.Format);
            }
